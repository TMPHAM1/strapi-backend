...
export interface PluginShopifySession extends Schema.CollectionType {
  ...
  attributes: {
    ...
    accessToken: Attribute.String & Attribute.Private;
    onlineAccessInfo: Attribute.JSON;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::shopify.session',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface PluginShopifyShop extends Schema.CollectionType {
  collectionName: 'shopify_shops';
  info: {
    singularName: 'shop';
    pluralName: 'shops';
    displayName: 'Shop';
  ...
  attributes: {
    shopify_id: Attribute.BigInteger & Attribute.Required & Attribute.Unique;
    domain: Attribute.String & Attribute.Required & Attribute.Unique;
    email: Attribute.String;
    installed: Attribute.Boolean & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::shopify.shop',
...
export interface PluginShopifyPlan extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    recurringPrice: Attribute.Decimal &
      Attribute.Required &
      Attribute.SetMinMax<{
        min: 0;
      }>;
    recurringInterval: Attribute.Enumeration<['EVERY_30_DAYS', 'ANNUAL']> &
      Attribute.Required;
    usageTerms: Attribute.Text & Attribute.Required;
    usageCappedAmount: Attribute.Decimal &
      Attribute.Required &
      Attribute.SetMinMax<{
        min: 0;
      }> &
      Attribute.DefaultTo<0>;
    currencyCode: Attribute.Enumeration<['USD']> &
      Attribute.Required &
      Attribute.DefaultTo<'USD'>;
    trialDays: Attribute.Integer &
      Attribute.Required &
      Attribute.SetMinMax<{
        min: 0;
      }>;
    test: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::shopify.plan',
...
export interface PluginShopifySubscription extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Required;
    trial_ends_on: Attribute.Date;
    confirmation_url: Attribute.String;
    test: Attribute.Boolean;
    shop: Attribute.Relation<
      'plugin::shopify.subscription',
      'oneToOne',
      'plugin::shopify.shop'
    > &
      Attribute.Required;
    ...
    > &
      Attribute.Required;
    usage_records: Attribute.Relation<
      'plugin::shopify.subscription',
      'oneToMany',
      'plugin::shopify.usage-record'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface PluginShopifyUsageRecord extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'plugin::shopify.session': PluginShopifySession;
      'plugin::shopify.shop': PluginShopifyShop;
      'plugin::shopify.plan': PluginShopifyPlan;
      'plugin::shopify.subscription': PluginShopifySubscription;
      'plugin::shopify.usage-record': PluginShopifyUsageRecord;
